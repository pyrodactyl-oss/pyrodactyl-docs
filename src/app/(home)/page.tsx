...
const features = [
  ...
  },
  {
    ...
    description: (
      <>
        It&apos;s everything you need, out-of-the-box. There&apos;s no need to
        install plugins or themes. (But you still can with{" "}
        <a
          href="/docs/blueprint"
    ...
    <>
        ...
        <div className="relative container mx-auto px-6 pt-40 pb-20">
          <div className="flex flex-col items-center text-center max-w-4xl mx-auto mb-20">
            ...
            <p className="text-lg md:text-xl text-white/60 max-w-2xl mb-10 leading-relaxed">
              Pyrodactyl is the world's best Pterodactyl panel. Unmatched
      ...
      <section className="relative z-10 w-full bg-[#09090b] border-t border-white/5 mt-[-250px]">
        <div
          ...
          style={{
            background:
              "linear-gradient(to top, #09090b 0%, rgba(9,9,11,0.95) 40%, rgba(9,9,11,0.7) 70%, rgba(9,9,11,0) 100%)",
          }}
        />
          ...
          <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            <div>
              ...
              <h2 className="font-extrabold text-[clamp(3rem,7vw,6rem)] leading-[0.95] tracking-[-0.04em] mb-8 font-[family-name:var(--font-display)]">
                ...
                <span className="block text-[0.6em] text-white/40">
                  smaller footprint
                </span>
              </h2>
              ...
              <p className="text-white/50 text-lg max-w-md leading-relaxed">
                We rebuilt Pterodactyl from the ground up. The result?
                Unprecedented performance that no other panel can match.
              </p>
            </div>

            <div className="space-y-6">
              <h3 className="text-sm font-medium text-white/40 mb-8">
                ...
                <div key={item.name}>
                  <div className="flex justify-between items-baseline mb-2">
                    <div className="flex items-center gap-3">
                      <span
                        className={`font-semibold ${item.highlight ? "text-brand" : "text-white/70"}`}
                      >
                        {item.name}
                      </span>
                    ...
                    <span
                      className={`font-mono text-sm ${item.highlight ? "text-brand" : "text-white/50"}`}
                    >
                      {item.time}
                    </span>
                  </div>
                  ...
                  <div className="h-2 bg-white/5 rounded-full overflow-hidden">
                    <div
                      ...
                      style={{
                        ...
                        minWidth: item.highlight ? "4px" : undefined,
                      }}
                    />
                  </div>
                </div>
              ...
              <p className="text-xs text-white/30 pt-4 leading-relaxed">
                Benchmarked on MacBook Pro M3 Max, 48GB RAM. Caching enabled for
                all builds. Results may vary based on configuration. Note: These
                benchmarks were done in 2024 and may not represent current build
                times.
              </p>
            </div>
          </div>
        ...
        <div className="container mx-auto px-6 py-24 md:py-32">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-white/50 text-lg leading-relaxed">
              Every aspect of Pyrodactyl has been carefully designed to deliver
              the best possible experience for server administrators.
            </p>
          </div>
        ...
        <div className="container mx-auto px-6 py-24 md:py-32">
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            <div className="space-y-3 font-mono text-base lg:text-lg">
              <div>
                <span className="inline-block bg-red-500/10 rounded px-3 py-1.5 text-red-300/80">
                  ghcr.io/pterodactyl/panel:latest
                </span>
              </div>
              <div>
                <span className="inline-block bg-green-500/10 rounded px-3 py-1.5 text-green-300/80">
                  ghcr.io/pyrodactyl-oss/pyrodactyl:latest
                </span>
              </div>
            </div>
            ...
            <div>
              ...
              <p className="text-white/50 text-lg mb-8 leading-relaxed">
                Already running Pterodactyl with Docker? Just change the image
                in your compose file and run{" "}
                <code className="text-brand">docker compose up -d</code>.
              </p>

              <div className="flex flex-col sm:flex-row gap-4">
                <PyroButton
                  variant="primary"
                  href="/docs/pyrodactyl/migrations"
                  isArrow
                >
                  Migration Guide
                </PyroButton>
                <PyroButton
                  variant="quaternary"
                  href="/docs/pyrodactyl/installation"
                >
                  Fresh Install
                </PyroButton>
              </div>
        ...
        <div className="container mx-auto px-6 py-24 md:py-32">
          <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            <div>
              ...
              <p className="text-white/50 text-lg mb-8 leading-relaxed">
                Unlike other panels, Pyrodactyl&apos;s entire codebase is
                publicly available. Audit the code, contribute improvements, or
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <PyroButton
                  variant="quaternary"
                  href="https://github.com/pyrodactyl-oss/pyrodactyl/blob/main/LICENSE.md"
                  external
                >
...
`}
                  <span className="text-purple-400/70">namespace</span>
                  {` Pterodactyl\\Listeners\\Auth;
...
{
    `}
                  <span className="text-purple-400/70">public function</span>
                  {` `}
                  <span className="text-blue-400/70">handle</span>
                  {`($event): void
    {
        Activity::`}
                  <span className="text-blue-400/70">event</span>
                  {`(`}
                  <span className="text-green-400/70">'password-reset'</span>
                  {`)
            ->`}
                  <span className="text-blue-400/70">subject</span>
                  {`($event->user)
            ->`}
        ...
        <div className="container mx-auto px-6 py-24 md:py-32">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-white/50 text-lg mb-10 leading-relaxed">
              Join the growing number of people using Pyrodactyl and deploy in
              minutes.
            </p>
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="flex items-center gap-3">
              ...
              <span className="text-white/40 text-sm">
                © {new Date().getFullYear()} Pyro Inc and its contributors.
              </span>
            </div>
