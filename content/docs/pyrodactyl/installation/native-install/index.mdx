...
This process is also quite straight-forward.
  ...
  ```bash
  curl -Lo panel.tar.gz https://github.com/pyrodactyl-oss/pyrodactyl/releases/latest/download/panel.tar.gz
...
This queue is responsible for sending emails and handling many other background tasks for Pyrodactyl.
