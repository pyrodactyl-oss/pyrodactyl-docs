...
<div className="not-prose mt-6 flex items-center gap-3 rounded-lg border border-green-500/20 bg-green-500/5 px-5 py-4">
  <Icon name="party-popper" className="size-6 text-green-400" />
  <span className="text-sm font-medium text-green-400">Boom! Your panel is now migrated to Pyrodactyl!</span>
</div>
