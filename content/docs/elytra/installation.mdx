...
- [certbot](https://github.com/certbot/certbot) (Optional if using SSL)
...
<ul>
  <li>
    <p>Name</p>
    <p>Give it a unique name that you can identify this node by</p>
  </li>
  <li>
    <p>Public FQDN</p>
    ...
    <p>If your panel is https secured is has to be a domain name, and vise versa, if it's http, it has to be an ip address.</p>
  </li>
  <li>
    <p>Total Memory</p>
    <p>How much memory your Server has</p>
  ...
  <li>
    ...
    <p>How much percent over your Total Memory you want to show up as "Available"</p>
  </li>
  <li>
    <p>Total Disk Space</p>
    <p>How much disk space you have to use</p>
    <Callout type='warn'> This is not a hard value. The panel will only get mad at you, not stop you!</Callout>
  </li>
  <li>
    <p>Disk Over-Allocation</p>
    <p>How much percent over your Total Disk you want to show up as "Available"</p>
    <Callout type='warn'>If your going to run Elytra behind a proxy Set Behind proxy to true</Callout>
  </li>
</ul>
...
<Tabs items={"Fedora,Ubuntu,Debian,Rocky,RHEL,Arch".split(',')}>
<Tab value="Fedora">
```
